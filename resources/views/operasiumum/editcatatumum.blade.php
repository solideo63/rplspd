            ...
            <form class="max-w-sm mx-auto pt-6" action="{{ route('operasi-umum.update', $operasiUmum->id) }}"
                ...
                <div class="flex justify-end">
                    <button type="submit" onclick="return confirm('Apakah Anda Yakin Akan Mengedit Ini?')"
                        ...
                        hover:bg-blue-900 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Kirim Perubahan
                    </button>
                </div>
            </form>
