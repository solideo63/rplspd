...
<div class="p-4 sm:ml-64 mt-4 ">
    <a href="{{  route('admin.tambah.faq') }}"><button type="button" style="background-color: #FCBE11;" class="text-white hover:opacity-90 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">Tambah FaQ</button></a>
